...
HD_PWD='C:/Users/aleen/block_blast_game_final/block_blast_game_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_blast_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_blast_top.tcl
