...
HD_PWD='C:/Users/aleen/block_blast_game_final/block_blast_game_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block_blast_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source block_blast_top.tcl -notrace
